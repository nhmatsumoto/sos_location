import { Activity, AlertTriangle, BarChart3, FileWarning, Layers3, LifeBuoy, Radar, Search, Settings, Users, PlugZap, Globe2 } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/global-disasters', label: 'Eventos Globais', icon: Globe2 },
